...
Source code for this guide is in [Github](./../../src/spring-guides/gs-spring-boot-kubernetes/tree/master/getting-started). It is deployed in [Katacoda](https://www.katacoda.com/springguides/scenarios/getting-started) where you can run the code interactively in your browser.